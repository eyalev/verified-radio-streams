# RCV+ Radio Cabo Verde Jovem

🇨🇻 Radio from **[Cape Verde](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/cape-verde/rcv-radio-cabo-verde-jovem/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.rtc.cv/rcvm)
- 🎧 Direct stream: [`https://a8.my-control-panel.com:8670/radio.mp3`](https://a8.my-control-panel.com:8670/radio.mp3) — paste into VLC, mpv, or any player

```bash
mpv "https://a8.my-control-panel.com:8670/radio.mp3"
```
