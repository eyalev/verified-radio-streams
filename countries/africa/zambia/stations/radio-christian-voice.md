...
🇿🇲 Radio from **[Zambia](../README.md)** · lusaka

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/zambia/radio-christian-voice/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://rcv.co.zm/)
- 🎧 Direct stream: [`https://streaming.shoutcast.com/rcv`](https://streaming.shoutcast.com/rcv) — paste into VLC, mpv, or any player

```bash
mpv "https://streaming.shoutcast.com/rcv"
```
...
- [One Love Radio](one-love-radio.md)
