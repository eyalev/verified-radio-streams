...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/mozambique/lm-radio-mozambique/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://lmradio.co.mz/)
- 🎧 Direct stream: [`https://edge.iono.fm/xice/392_medium.mp3`](https://edge.iono.fm/xice/392_medium.mp3) — paste into VLC, mpv, or any player

```bash
mpv "https://edge.iono.fm/xice/392_medium.mp3"
```
