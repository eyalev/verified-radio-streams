...
🇨🇩 Radio from **[Congo - Kinshasa](../README.md)** · Kinshasa

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/congo-kinshasa/kolo-mboka-fm/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://volticast.com/r/kolo-mbokafm)
- 🎧 Direct stream: [`https://kolo-mbokafm.volticast.net/kolo-mbokafm.mp3`](https://kolo-mbokafm.volticast.net/kolo-mbokafm.mp3) — paste into VLC, mpv, or any player

```bash
mpv "https://kolo-mbokafm.volticast.net/kolo-mbokafm.mp3"
```
...
| | |
|---|---|
| Country | 🇨🇩 [Congo - Kinshasa](../README.md) |
| Region | Kinshasa |
| Language | french |
| Quality | 96 kbps AAC |
...
## More from Congo - Kinshasa

- [Top Congo FM](top-congo-fm.md)
- [rmbb](rmbb.md)
- [Abdulbasit Abdulsamad](abdulbasit-abdulsamad.md)

[**All 4 stations in Congo - Kinshasa →**](../README.md)

---

[← Congo - Kinshasa](../README.md) · [Africa](../../README.md) · [All countries](../../../README.md) · [Repo home](../../../../README.md) · [globalradio.app](https://globalradio.app)
