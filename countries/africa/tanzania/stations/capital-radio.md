...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/tanzania/capital-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.capitalradio.co.tz/)
- 🎧 Direct stream: [`https://capitalradio.radioca.st/stream`](https://capitalradio.radioca.st/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://capitalradio.radioca.st/stream"
```
...
- [Radio One Stereo](radio-one-stereo.md)
