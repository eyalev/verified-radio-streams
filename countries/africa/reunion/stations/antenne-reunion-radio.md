...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/reunion/antenne-reunion-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.antennereunionradio.fr/)
- 🎧 Direct stream: [`https://rtlre.ice.infomaniak.ch/rtlre-64.aac`](https://rtlre.ice.infomaniak.ch/rtlre-64.aac) — paste into VLC, mpv, or any player

```bash
mpv "https://rtlre.ice.infomaniak.ch/rtlre-64.aac"
```
