...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/mauritius/radioplus-fever/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://live.radioplus.mu/)
- 🎧 Direct stream: [`https://streamer.radio.co/s3fe39a4a4/listen`](https://streamer.radio.co/s3fe39a4a4/listen) — paste into VLC, mpv, or any player

```bash
mpv "https://streamer.radio.co/s3fe39a4a4/listen"
```
