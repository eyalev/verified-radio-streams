...
🇲🇺 Radio from **[Mauritius](../README.md)** · LE TAMPON

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/mauritius/sensuelle-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://sensuelleradio.com/)
- 🎧 Direct stream: [`https://forwardmystream.com/sensuelleradio`](https://forwardmystream.com/sensuelleradio) — paste into VLC, mpv, or any player

```bash
mpv "https://forwardmystream.com/sensuelleradio"
```
