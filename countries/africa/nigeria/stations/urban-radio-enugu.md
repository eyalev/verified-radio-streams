...
🇳🇬 Radio from **[Nigeria](../README.md)** · Enugu

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/nigeria/urban-radio-enugu/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.urbanradio945.com/)
- 🎧 Direct stream: [`https://edge.mixlr.com/channel/cfldr`](https://edge.mixlr.com/channel/cfldr) — paste into VLC, mpv, or any player

```bash
mpv "https://edge.mixlr.com/channel/cfldr"
```
...
- [Splash FM 105.5](splash-fm-105-5.md)
- [Gospotainment Radio](gospotainment-radio.md) — gospel
- #Radio Quran — classical
- [HOD RADIO](hod-radio.md)
- Praiseworld Radio
- LagosJump Radio

[**All 34 stations in Nigeria →**](../README.md)

---

[← Nigeria](../README.md) · [Africa](../../README.md) · [All countries](../../../README.md) · [Repo home](../../../../README.md) · [globalradio.app](https://globalradio.app)
