...
🇹🇳 Radio from **[Tunisia](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/tunisia/diwanfm/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://diwanfm.net/)
- 🎧 Direct stream: [`https://streaming.diwanfm.net/stream`](https://streaming.diwanfm.net/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://streaming.diwanfm.net/stream"
```
...
- Mosaique FM — classical
- [Mosaique FM Tarab](mosaique-fm-tarab.md)
- تراتيل — classical
- [Mosaique FM Gold](mosaique-fm-gold.md)
- [Mosaique FM Tounsi](mosaique-fm-tounsi.md)
- Radio Tunisia Med

[**All 23 stations in Tunisia →**](../README.md)

---

[← Tunisia](../README.md) · [Africa](../../README.md) · [All countries](../../../README.md) · [Repo home](../../../../README.md) · [globalradio.app](https://globalradio.app)
