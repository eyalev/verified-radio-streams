...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/tunisia/mosaique-fm-gold/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](http://mosaiquefm.net/)
- 🎧 Direct stream: [`https://radio.mosaiquefm.net/mosagold`](https://radio.mosaiquefm.net/mosagold) — paste into VLC, mpv, or any player

```bash
mpv "https://radio.mosaiquefm.net/mosagold"
```
