...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/tunisia/mosaique-fm-tarab/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](http://mosaiquefm.net/)
- 🎧 Direct stream: [`https://radio.mosaiquefm.net/mosatarab`](https://radio.mosaiquefm.net/mosatarab) — paste into VLC, mpv, or any player

```bash
mpv "https://radio.mosaiquefm.net/mosatarab"
```
