...
🇦🇴 Radio from **[Angola](../README.md)** · Luanda

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/angola/radio-luanda/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://rna.ao/)
- 🎧 Direct stream: [`https://paineldj5.com.br:20089/stream`](https://paineldj5.com.br:20089/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://paineldj5.com.br:20089/stream"
```
