...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/maldives/dhivehi-fm/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://psmnews.mv/stream/tvm)
- 🎧 Direct stream: [`https://radio.psm.mv/fmair`](https://radio.psm.mv/fmair) — paste into VLC, mpv, or any player

```bash
mpv "https://radio.psm.mv/fmair"
```
