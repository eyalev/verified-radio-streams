...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/maldives/dhivehi-raajjeyge-adu/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://psmnews.mv/stream/radio-dhivehi-raajjeyge-adu)
- 🎧 Direct stream: [`https://radio.psm.mv/draair`](https://radio.psm.mv/draair) — paste into VLC, mpv, or any player

```bash
mpv "https://radio.psm.mv/draair"
```
