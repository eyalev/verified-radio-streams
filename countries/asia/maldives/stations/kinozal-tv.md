...
🇲🇻 Radio from **[Maldives](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/maldives/kinozal-tv/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://kinozal.tv/radio.php)
- 🎧 Direct stream: [`https://listen7.myradio24.com/kinozaltv`](https://listen7.myradio24.com/kinozaltv) — paste into VLC, mpv, or any player

```bash
mpv "https://listen7.myradio24.com/kinozaltv"
```
...
| | |
|---|---|
| Country | 🇲🇻 [Maldives](../README.md) |
| Language | dhivehi, english, french, german |
...
- [Dhivehi FM](dhivehi-fm.md)
- [Abdulbasit Abdulsamad](abdulbasit-abdulsamad.md)
- [Dhivehi Raajjeyge Adu](dhivehi-raajjeyge-adu.md)

[**All 4 stations in Maldives →**](../README.md)

---

[← Maldives](../README.md) · [Asia](../../README.md) · [All countries](../../../README.md) · [Repo home](../../../../README.md) · [globalradio.app](https://globalradio.app)
