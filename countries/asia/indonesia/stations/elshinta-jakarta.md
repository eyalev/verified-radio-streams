...
🇮🇩 Radio from **[Indonesia](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/indonesia/elshinta-jakarta/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://elshinta.com/radio)
- 🎧 Direct stream: [`https://stream-ssl.arenastreaming.com:8000/jakarta`](https://stream-ssl.arenastreaming.com:8000/jakarta) — paste into VLC, mpv, or any player

```bash
mpv "https://stream-ssl.arenastreaming.com:8000/jakarta"
```
