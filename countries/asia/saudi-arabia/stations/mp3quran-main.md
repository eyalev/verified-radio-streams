...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/saudi-arabia/mp3quran-main/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.mp3quran.net/)
- 🎧 Direct stream: [`https://qurango.net/radio/mix`](https://qurango.net/radio/mix) — paste into VLC, mpv, or any player

```bash
mpv "https://qurango.net/radio/mix"
```
