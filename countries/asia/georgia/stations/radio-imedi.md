# რადიო იმედი (Radio Imedi)

🇬🇪 Radio from **[Georgia](../README.md)** · Tbilisi

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/georgia/radio-imedi/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.imedi.ge/)
- 🎧 Direct stream: [`https://tv.cdn.xsg.ge/radioimedi/stream01/shoutcast`](https://tv.cdn.xsg.ge/radioimedi/stream01/shoutcast) — paste into VLC, mpv, or any player

```bash
mpv "https://tv.cdn.xsg.ge/radioimedi/stream01/shoutcast"
```
...
| | |
|---|---|
| Country | 🇬🇪 [Georgia](../README.md) |
| Region | Tbilisi |
| Language | georgian |
| Quality | 132 kbps AAC |
...
- Radio Amra — classical
- [WVFJ 93.3 & 102.1 The JOY FM](wvfj-93-3-102-1-the-joy-fm.md)
- [რადიო პოზიტივი (Radio Positive)](radio-positive.md)
- [LF Radio](lf-radio.md)
- რადიო პალიტრა (Radio Palitra)
- რადიო სივრცე (Radio Sivrce)

[**All 11 stations in Georgia →**](../README.md)

---

[← Georgia](../README.md) · [Asia](../../README.md) · [All countries](../../../README.md) · [Repo home](../../../../README.md) · [globalradio.app](https://globalradio.app)
