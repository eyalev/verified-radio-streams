...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/brunei/kristal-fm/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.kristal.fm/)
- 🎧 Direct stream: [`https://play.thestreamtech.com:7038/`](https://play.thestreamtech.com:7038/) — paste into VLC, mpv, or any player

```bash
mpv "https://play.thestreamtech.com:7038/"
```
