...
🇵🇸 Radio from **[Palestinian Territories](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/palestinian-territories/raya-fm/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://radiostream.novawap.com/)
- 🎧 Direct stream: [`https://rstream.hadara.ps/proxy/raya/stream`](https://rstream.hadara.ps/proxy/raya/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://rstream.hadara.ps/proxy/raya/stream"
```
...
| | |
|---|---|
| Country | 🇵🇸 [Palestinian Territories](../README.md) |
...
- [راديو الناس](nasradio.md) — music
- #Radio Quran — classical
- [CAMP Radio](camp-radio.md)
- [Abdulbasit Abdulsamad](abdulbasit-abdulsamad.md)
- Ajyal - Palestine
- Sawt El Ghad - Tarab — oldies

[**All 7 stations in Palestinian Territories →**](../README.md)

---

[← Palestinian Territories](../README.md) · [Asia](../../README.md) · [All countries](../../../README.md) · [Repo home](../../../../README.md) · [globalradio.app](https://globalradio.app)
