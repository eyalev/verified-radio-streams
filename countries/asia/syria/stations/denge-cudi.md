...
🇸🇾 Radio from **[Syria](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/syria/denge-cudi/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://denge-cudi.stream.laut.fm/)
- 🎧 Direct stream: [`https://denge-cudi.stream.laut.fm/denge-cudi?pl=m3u`](https://denge-cudi.stream.laut.fm/denge-cudi?pl=m3u) — paste into VLC, mpv, or any player

```bash
mpv "https://denge-cudi.stream.laut.fm/denge-cudi?pl=m3u"
```
...
- [Exclusively Meat Loaf](exclusively-meat-loaf.md) — pop
- .. مختصر التفسير — classical
- [Syria TV - راديو تلفزيون سوريا](syria-tv.md)
- [Denge Qamishlo](denge-qamishlo.md)
- Rayan FM
- Al Karma FM

[**All 8 stations in Syria →**](../README.md)

---

[← Syria](../README.md) · [Asia](../../README.md) · [All countries](../../../README.md) · [Repo home](../../../../README.md) · [globalradio.app](https://globalradio.app)
