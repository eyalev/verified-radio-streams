...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/turkiye/haberturk-radyo/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.haberturkradyo.com.tr/)
- 🎧 Direct stream: [`https://haberturkradyo.radyotvonline.net/haberturkradyo`](https://haberturkradyo.radyotvonline.net/haberturkradyo) — paste into VLC, mpv, or any player

```bash
mpv "https://haberturkradyo.radyotvonline.net/haberturkradyo"
```
