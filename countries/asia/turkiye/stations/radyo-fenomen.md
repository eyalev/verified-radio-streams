...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/turkiye/radyo-fenomen/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.radyofenomen.com/)
- 🎧 Direct stream: [`https://live.radyofenomen.com/fenomen/128/icecast.audio`](https://live.radyofenomen.com/fenomen/128/icecast.audio) — paste into VLC, mpv, or any player

```bash
mpv "https://live.radyofenomen.com/fenomen/128/icecast.audio"
```
