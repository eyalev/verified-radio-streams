...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/kyrgyzstan/kyrgyzstan-obondoru/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://obondoru.kg/)
- 🎧 Direct stream: [`https://cdn.radioplayer.kg:8443/obondoru64`](https://cdn.radioplayer.kg:8443/obondoru64) — paste into VLC, mpv, or any player

```bash
mpv "https://cdn.radioplayer.kg:8443/obondoru64"
```
...
- [Сүйүнчү FM (Suiunchu FM)](fm-suiunchu-fm.md)
