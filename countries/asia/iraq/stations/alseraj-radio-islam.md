...
🇮🇶 Radio from **[Iraq](../README.md)** · KARBALA

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/iraq/alseraj-radio-islam/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.alserajradio.com/)
- 🎧 Direct stream: [`https://eu4.fastcast4u.com/proxy/aabdul00?mp=/1`](https://eu4.fastcast4u.com/proxy/aabdul00?mp=/1) — paste into VLC, mpv, or any player

```bash
mpv "https://eu4.fastcast4u.com/proxy/aabdul00?mp=/1"
```
...
- [SumerFm Iraq](sumerfm-iraq.md) — music
- . Al quran radio — classical
- .. مختصر التفسير — classical
- [Al-bilad Radio/Yaqoubi](al-bilad-radio-yaqoubi.md)
- [Darusalam Radio](darusalam-radio.md)
- Al rasheed fm

[**All 15 stations in Iraq →**](../README.md)

---

[← Iraq](../README.md) · [Asia](../../README.md) · [All countries](../../../README.md) · [Repo home](../../../../README.md) · [globalradio.app](https://globalradio.app)
