...
🇮🇶 Radio from **[Iraq](../README.md)** · Baghdad

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/iraq/darusalam-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.darusalamradio.net/)
- 🎧 Direct stream: [`https://streams.radio.co/s0975ec186/listen`](https://streams.radio.co/s0975ec186/listen) — paste into VLC, mpv, or any player

```bash
mpv "https://streams.radio.co/s0975ec186/listen"
```
...
- [Alseraj Radio Islam](alseraj-radio-islam.md)
- Al rasheed fm
