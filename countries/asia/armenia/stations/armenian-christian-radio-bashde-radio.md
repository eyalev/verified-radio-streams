...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/armenia/armenian-christian-radio-bashde-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](http://bashde.org/)
- 🎧 Direct stream: [`https://streams.radio.co/sa0bf8ec29/listen?sid=1`](https://streams.radio.co/sa0bf8ec29/listen?sid=1) — paste into VLC, mpv, or any player

```bash
mpv "https://streams.radio.co/sa0bf8ec29/listen?sid=1"
```
