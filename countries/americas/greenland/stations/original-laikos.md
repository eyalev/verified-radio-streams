...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/greenland/original-laikos/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://radiooriginallaikos.blogspot.com/)
- 🎧 Direct stream: [`https://play.streams.gr:22035/stream`](https://play.streams.gr:22035/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://play.streams.gr:22035/stream"
```
