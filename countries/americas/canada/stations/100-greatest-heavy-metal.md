...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/canada/100-greatest-heavy-metal/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://100-greatest-network.torontocast.stream/)
- 🎧 Direct stream: [`https://cast1.torontocast.com:4660/stream`](https://cast1.torontocast.com:4660/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://cast1.torontocast.com:4660/stream"
```
...
| Region | Ontario |
| Genre | `60s` `70s` `80s` `90s` `classic-hits` `classic-rock` `metal` `music` `musica` `oldies` `rock` |
| Language | english |
