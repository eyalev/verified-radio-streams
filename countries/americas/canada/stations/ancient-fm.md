...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/canada/ancient-fm/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.ancientfm.com/)
- 🎧 Direct stream: [`https://mediaserv73.live-streams.nl:18058/stream`](https://mediaserv73.live-streams.nl:18058/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://mediaserv73.live-streams.nl:18058/stream"
```
