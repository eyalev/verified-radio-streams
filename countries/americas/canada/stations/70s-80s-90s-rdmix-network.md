...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/canada/70s-80s-90s-rdmix-network/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://radiodimensionemix.torontocast.stream/)
- 🎧 Direct stream: [`https://cast1.torontocast.com:1830/stream`](https://cast1.torontocast.com:1830/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://cast1.torontocast.com:1830/stream"
```
...
| Region | Ontario |
| Genre | `70s` `80s` `90s` `classic-hits` `classic-rock` `dance` `hits` `music` `musica` `oldies` `pop` `pop-music` `pop-rock` `rock` `top-100` `top-hits` |
| Language | english |
