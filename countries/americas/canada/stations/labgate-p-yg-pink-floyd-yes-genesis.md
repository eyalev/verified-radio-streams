# Labgate P.YG. Pink Floyd, Yes, Genesis

🇨🇦 Radio from **[Canada](../README.md)** · Quebec

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/canada/labgate-p-yg-pink-floyd-yes-genesis/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://labgateradio.com/)
- 🎧 Direct stream: [`https://s2.ssl-stream.com/radio/8160/radio.mp3`](https://s2.ssl-stream.com/radio/8160/radio.mp3) — paste into VLC, mpv, or any player

```bash
mpv "https://s2.ssl-stream.com/radio/8160/radio.mp3"
```
