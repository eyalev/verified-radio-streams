...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/canada/rdmix-classic-rock-70s-80s-90s/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://radiodimensionemix.torontocast.stream/)
- 🎧 Direct stream: [`https://cast1.torontocast.com:4610/stream`](https://cast1.torontocast.com:4610/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://cast1.torontocast.com:4610/stream"
```
...
| Region | Ontario |
| Genre | `60s` `70s` `80s` `90s` `blues` `classic-hits` `classic-rock` `country` `hits` `music` `musica` `oldies` `pop-rock` `rock` |
| Language | english |
