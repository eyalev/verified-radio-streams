...
🇨🇦 Radio from **[Canada](../README.md)** · ontario

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/canada/70-80-90-vibrazioni-rock-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://radiosuitenetwork.torontocast.stream/vibrazioni-rock-radio/)
- 🎧 Direct stream: [`https://maggie.torontocast.com:2020/stream/vibrazionirockradio`](https://maggie.torontocast.com:2020/stream/vibrazionirockradio) — paste into VLC, mpv, or any player

```bash
mpv "https://maggie.torontocast.com:2020/stream/vibrazionirockradio"
```
...
| Region | ontario |
| Genre | `70s` `80s` `90s` `blues` `classic-rock` `pop-rock` `rock` |
| Language | english |
...
- [Nature Radio Rain](nature-radio-rain.md) — ambient, relax, relaxing
