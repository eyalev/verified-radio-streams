...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/canada/airport-lounge-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://radiosuitenetwork.torontocast.stream/airport-lounge-radio/)
- 🎧 Direct stream: [`https://az1.mediacp.eu/listen/airport-lounge-radio/radio.mp3`](https://az1.mediacp.eu/listen/airport-lounge-radio/radio.mp3) — paste into VLC, mpv, or any player

```bash
mpv "https://az1.mediacp.eu/listen/airport-lounge-radio/radio.mp3"
```
...
| Region | Ontario |
| Genre | `ambient` `chillout` `easy-listening` `house` `lounge` `smooth-jazz` |
| Language | english |
