...
🇨🇦 Radio from **[Canada](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/canada/80-s-new-wave-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://newwaveradio.org/)
- 🎧 Direct stream: [`https://puma.streemlion.com:2910/stream`](https://puma.streemlion.com:2910/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://puma.streemlion.com:2910/stream"
```
