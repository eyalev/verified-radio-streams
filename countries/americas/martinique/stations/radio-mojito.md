...
🇲🇶 Radio from **[Martinique](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/martinique/radio-mojito/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.ckradio.fr/)
- 🎧 Direct stream: [`https://fmcpmediatest.ice.infomaniak.ch/fmcp-128.mp3`](https://fmcpmediatest.ice.infomaniak.ch/fmcp-128.mp3) — paste into VLC, mpv, or any player

```bash
mpv "https://fmcpmediatest.ice.infomaniak.ch/fmcp-128.mp3"
```
...
## More from Martinique

- [Radio Zoukla](radio-zoukla.md)
- [Abdulbasit Abdulsamad](abdulbasit-abdulsamad.md)
- [RCI Dancehall](rci-dancehall.md)

[**All 4 stations in Martinique →**](../README.md)

---

[← Martinique](../README.md) · [Americas](../../README.md) · [All countries](../../../README.md) · [Repo home](../../../../README.md) · [globalradio.app](https://globalradio.app)
