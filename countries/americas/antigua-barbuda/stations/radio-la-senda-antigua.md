...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/antigua-barbuda/radio-la-senda-antigua/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.iglesialasendaantigua.com/)
- 🎧 Direct stream: [`https://play10.tikast.com/proxy/lasenda?mp=/stream`](https://play10.tikast.com/proxy/lasenda?mp=/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://play10.tikast.com/proxy/lasenda?mp=/stream"
```
