...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/aruba/canal90-fm/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://canal90fm.aw/)
- 🎧 Direct stream: [`https://stream.canal90.fm/live`](https://stream.canal90.fm/live) — paste into VLC, mpv, or any player

```bash
mpv "https://stream.canal90.fm/live"
```
