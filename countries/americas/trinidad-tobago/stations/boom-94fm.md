...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/trinidad-tobago/boom-94fm/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://boomchampionstt.com/)
- 🎧 Direct stream: [`https://s8.yesstreaming.net:17103/stream`](https://s8.yesstreaming.net:17103/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://s8.yesstreaming.net:17103/stream"
```
...
- TAMBRIN — pop
- [95 the ultimate one](95-the-ultimate-one.md)
