...
🇨🇱 Radio from **[Chile](../README.md)** · Región Metropolitana

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/chile/radio-el-conquistador-fm-santiago/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.elconquistadorfm.cl/)
- 🎧 Direct stream: [`https://stream10.usastreams.com/9314/stream/`](https://stream10.usastreams.com/9314/stream/) — paste into VLC, mpv, or any player

```bash
mpv "https://stream10.usastreams.com/9314/stream/"
```
