...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/chile/radio-bio-bio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.biobiochile.cl/)
- 🎧 Direct stream: [`https://unlimited3-cl.dps.live/biobiosantiago/mp3/icecast.audio`](https://unlimited3-cl.dps.live/biobiosantiago/mp3/icecast.audio) — paste into VLC, mpv, or any player

```bash
mpv "https://unlimited3-cl.dps.live/biobiosantiago/mp3/icecast.audio"
```
