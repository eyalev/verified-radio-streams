...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/chile/radio-sol-classic/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://radiosol.cl/)
- 🎧 Direct stream: [`https://us9.maindigitalstream.com/ssl/radiosol`](https://us9.maindigitalstream.com/ssl/radiosol) — paste into VLC, mpv, or any player

```bash
mpv "https://us9.maindigitalstream.com/ssl/radiosol"
```
