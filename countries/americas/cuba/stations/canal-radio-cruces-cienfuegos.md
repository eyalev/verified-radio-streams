...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/cuba/canal-radio-cruces-cienfuegos/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://canalradio.caster.fm/)
- 🎧 Direct stream: [`https://stream.laut.fm/canalradio`](https://stream.laut.fm/canalradio) — paste into VLC, mpv, or any player

```bash
mpv "https://stream.laut.fm/canalradio"
```
