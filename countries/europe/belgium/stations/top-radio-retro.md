...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/belgium/top-radio-retro/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.topradio.be/)
- 🎧 Direct stream: [`https://str.topradio.be/topradioretroarena.mp3`](https://str.topradio.be/topradioretroarena.mp3) — paste into VLC, mpv, or any player

```bash
mpv "https://str.topradio.be/topradioretroarena.mp3"
```
