...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/croatia/top-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://topradio.hr/)
- 🎧 Direct stream: [`https://c5.hostingcentar.com/streams/topradio/`](https://c5.hostingcentar.com/streams/topradio/) — paste into VLC, mpv, or any player

```bash
mpv "https://c5.hostingcentar.com/streams/topradio/"
```
