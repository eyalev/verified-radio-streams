...
🇭🇷 Radio from **[Croatia](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/croatia/yammat-fm/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.yammat.fm/)
- 🎧 Direct stream: [`https://stream.yammat.fm/radio/8000/yammat.mp3`](https://stream.yammat.fm/radio/8000/yammat.mp3) — paste into VLC, mpv, or any player

```bash
mpv "https://stream.yammat.fm/radio/8000/yammat.mp3"
```
