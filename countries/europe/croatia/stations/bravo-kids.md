...
🇭🇷 Radio from **[Croatia](../README.md)** · Grad Zagreb

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/croatia/bravo-kids/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://br.hr/)
- 🎧 Direct stream: [`https://audio.social3.hr/listen/bravo_kids/stream?3367`](https://audio.social3.hr/listen/bravo_kids/stream?3367) — paste into VLC, mpv, or any player

```bash
mpv "https://audio.social3.hr/listen/bravo_kids/stream?3367"
```
...
- [Otvoreni Radio](otvoreni-radio.md) — easy-listening, pop, rock
- [Yammat FM](yammat-fm.md)
- [Top Radio](top-radio.md)
- [Radio Kaj](radio-kaj.md) — pop
- [Radio Tvornica](radio-tvornica.md)
- Zagorski radio — folk, pop

[**All 71 stations in Croatia →**](../README.md)

---

[← Croatia](../README.md) · [Europe](../../README.md) · [All countries](../../../README.md) · [Repo home](../../../../README.md) · [globalradio.app](https://globalradio.app)
