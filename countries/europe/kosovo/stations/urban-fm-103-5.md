...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/kosovo/urban-fm-103-5/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://radiourban.fm/)
- 🎧 Direct stream: [`https://radio.itprishtina.com/urbanfm.ogg`](https://radio.itprishtina.com/urbanfm.ogg) — paste into VLC, mpv, or any player

```bash
mpv "https://radio.itprishtina.com/urbanfm.ogg"
```
