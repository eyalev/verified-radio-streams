...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/albania/radioone/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://radioone.al/)
- 🎧 Direct stream: [`https://cp1.sednastream.com/proxy/radioone94?mp=/stream`](https://cp1.sednastream.com/proxy/radioone94?mp=/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://cp1.sednastream.com/proxy/radioone94?mp=/stream"
```
...
- [Radio Shqip - Tirana 92.0 MHz](radio-shqip-tirana-92-0-mhz.md)
