...
🇭🇺 Radio from **[Hungary](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/hungary/dance-wave-retro/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://dancewave.online/)
- 🎧 Direct stream: [`https://retro.dancewave.online/retrodance.mp3`](https://retro.dancewave.online/retrodance.mp3) — paste into VLC, mpv, or any player

```bash
mpv "https://retro.dancewave.online/retrodance.mp3"
```
...
- [Retro Rádió](retro-radio.md) — pop, rock, 80s, 90s, 2000s
