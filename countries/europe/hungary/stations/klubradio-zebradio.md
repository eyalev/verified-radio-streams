...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/hungary/klubradio-zebradio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://zebradio.klubradio.hu/)
- 🎧 Direct stream: [`https://stream.zebradio.hu:8443/zebradio`](https://stream.zebradio.hu:8443/zebradio) — paste into VLC, mpv, or any player

```bash
mpv "https://stream.zebradio.hu:8443/zebradio"
```
