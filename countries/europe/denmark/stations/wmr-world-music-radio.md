...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/denmark/wmr-world-music-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.wmr.dk/#)
- 🎧 Direct stream: [`https://stream.probroadcast.dk/wmr`](https://stream.probroadcast.dk/wmr) — paste into VLC, mpv, or any player

```bash
mpv "https://stream.probroadcast.dk/wmr"
```
