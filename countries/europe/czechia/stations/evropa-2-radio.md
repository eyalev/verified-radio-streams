...
🇨🇿 Radio from **[Czechia](../README.md)** · Prague

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/czechia/evropa-2-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.evropa2.cz/)
- 🎧 Direct stream: [`https://ice.actve.net/fm-evropa2-128`](https://ice.actve.net/fm-evropa2-128) — paste into VLC, mpv, or any player

```bash
mpv "https://ice.actve.net/fm-evropa2-128"
```
