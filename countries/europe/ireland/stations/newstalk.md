...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/ireland/newstalk/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.newstalk.com/)
- 🎧 Direct stream: [`https://edge.audioxi.com/NT`](https://edge.audioxi.com/NT) — paste into VLC, mpv, or any player

```bash
mpv "https://edge.audioxi.com/NT"
```
...
- [Gem Radio New Wave](gem-radio-new-wave.md) — 70s, 80s
