...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/united-kingdom/talksport/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://talksport.com/)
- 🎧 Direct stream: [`https://radio.talksport.com/stream`](https://radio.talksport.com/stream) — paste into VLC, mpv, or any player

```bash
mpv "https://radio.talksport.com/stream"
```
