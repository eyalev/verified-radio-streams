...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/bulgaria/radio-nova-bulgaria/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](http://www.radionova.bg/)
- 🎧 Direct stream: [`https://play.global.audio/nova.opus`](https://play.global.audio/nova.opus) — paste into VLC, mpv, or any player

```bash
mpv "https://play.global.audio/nova.opus"
```
