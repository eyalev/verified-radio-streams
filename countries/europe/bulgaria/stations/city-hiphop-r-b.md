...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/bulgaria/city-hiphop-r-b/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://radioplay.bg/)
- 🎧 Direct stream: [`https://play.global.audio/cityrabhi.aac`](https://play.global.audio/cityrabhi.aac) — paste into VLC, mpv, or any player

```bash
mpv "https://play.global.audio/cityrabhi.aac"
```
