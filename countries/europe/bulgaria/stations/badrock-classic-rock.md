# BadRock Classic Rock

🇧🇬 Radio from **[Bulgaria](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/bulgaria/badrock-classic-rock/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://play-radio0.jump.bg:7489/live)
- 🎧 Direct stream: [`https://play-radio0.jump.bg:7489/live`](https://play-radio0.jump.bg:7489/live) — paste into VLC, mpv, or any player

```bash
mpv "https://play-radio0.jump.bg:7489/live"
```
