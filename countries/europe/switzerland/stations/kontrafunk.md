...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/switzerland/kontrafunk/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.kontrafunk.radio/)
- 🎧 Direct stream: [`https://s5.radio.co/sca4082ebb/listen`](https://s5.radio.co/sca4082ebb/listen) — paste into VLC, mpv, or any player

```bash
mpv "https://s5.radio.co/sca4082ebb/listen"
```
