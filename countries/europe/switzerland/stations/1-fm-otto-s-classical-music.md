...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/switzerland/1-fm-otto-s-classical-music/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.1.fm/station/classical)
- 🎧 Direct stream: [`https://strm112.1.fm/classical_mobile_aac`](https://strm112.1.fm/classical_mobile_aac) — paste into VLC, mpv, or any player

```bash
mpv "https://strm112.1.fm/classical_mobile_aac"
```
