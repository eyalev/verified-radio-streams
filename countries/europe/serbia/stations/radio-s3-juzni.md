...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/serbia/radio-s3-juzni/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.radios.rs/digitalni-radio/20/juzni)
- 🎧 Direct stream: [`https://stream.radios.rs:9038/;*.mp3`](https://stream.radios.rs:9038/;*.mp3) — paste into VLC, mpv, or any player

```bash
mpv "https://stream.radios.rs:9038/;*.mp3"
```
...
- [Play Radio Serbia](play-radio-serbia.md)
