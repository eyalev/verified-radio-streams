...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/serbia/play-radio-serbia/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.playradio.rs/)
- 🎧 Direct stream: [`https://stream.playradio.rs:8443/play.mp3`](https://stream.playradio.rs:8443/play.mp3) — paste into VLC, mpv, or any player

```bash
mpv "https://stream.playradio.rs:8443/play.mp3"
```
