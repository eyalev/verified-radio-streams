...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/serbia/naxi-80-e-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.naxi.rs/80e)
- 🎧 Direct stream: [`https://naxidigital-80s128ssl.streaming.rs:8042/;`](https://naxidigital-80s128ssl.streaming.rs:8042/;) — paste into VLC, mpv, or any player

```bash
mpv "https://naxidigital-80s128ssl.streaming.rs:8042/;"
```
