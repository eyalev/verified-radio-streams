...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/serbia/naxi-cafe-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.naxi.rs/cafe)
- 🎧 Direct stream: [`https://naxidigital-cafe128ssl.streaming.rs:8022/;`](https://naxidigital-cafe128ssl.streaming.rs:8022/;) — paste into VLC, mpv, or any player

```bash
mpv "https://naxidigital-cafe128ssl.streaming.rs:8022/;"
```
