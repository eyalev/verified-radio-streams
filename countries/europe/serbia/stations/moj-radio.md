...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/serbia/moj-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.mojradio.net/)
- 🎧 Direct stream: [`https://eu4.fastcast4u.com/proxy/svidakov?mp=/1`](https://eu4.fastcast4u.com/proxy/svidakov?mp=/1) — paste into VLC, mpv, or any player

```bash
mpv "https://eu4.fastcast4u.com/proxy/svidakov?mp=/1"
```
