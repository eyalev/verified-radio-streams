...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/ukraine/96-0/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://radio.nv.ua/)
- 🎧 Direct stream: [`https://online-radio.nv.ua/radionv.mp3`](https://online-radio.nv.ua/radionv.mp3) — paste into VLC, mpv, or any player

```bash
mpv "https://online-radio.nv.ua/radionv.mp3"
```
