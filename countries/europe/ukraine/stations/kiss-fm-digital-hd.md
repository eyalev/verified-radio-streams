...
🇺🇦 Radio from **[Ukraine](../README.md)** · Kiev

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/ukraine/kiss-fm-digital-hd/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://play.tavr.media/kissfm/digital/)
- 🎧 Direct stream: [`https://online.kissfm.ua/KissFM_Digital_HD`](https://online.kissfm.ua/KissFM_Digital_HD) — paste into VLC, mpv, or any player

```bash
mpv "https://online.kissfm.ua/KissFM_Digital_HD"
```
