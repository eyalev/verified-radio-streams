...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/iceland/k-100/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://k100.mbl.is/)
- 🎧 Direct stream: [`https://ice-11.spilarinn.is/kaninnmobile`](https://ice-11.spilarinn.is/kaninnmobile) — paste into VLC, mpv, or any player

```bash
mpv "https://ice-11.spilarinn.is/kaninnmobile"
```
