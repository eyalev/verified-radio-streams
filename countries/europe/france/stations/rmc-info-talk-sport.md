...
🇫🇷 Radio from **[France](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/france/rmc-info-talk-sport/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://rmc.bfmtv.com/)
- 🎧 Direct stream: [`https://audio.bfmtv.com/rmcradio_128.mp3?aw_0_1st.playerId=RMC_audio_web&aggregator=RMC_audio_web`](https://audio.bfmtv.com/rmcradio_128.mp3?aw_0_1st.playerId=RMC_audio_web&aggregator=RMC_audio_web) — paste into VLC, mpv, or any player

```bash
mpv "https://audio.bfmtv.com/rmcradio_128.mp3?aw_0_1st.playerId=RMC_audio_web&aggregator=RMC_audio_web"
```
...
- [RMC FR](rmc-fr.md)
- [EuroDance 90 radio](eurodance-90-radio.md) — pop-music
- [Sud Radio](sud-radio.md)
- [BFM radio](bfm-radio.md)
- [Europe 1](europe-1.md)
- 法国国际广播电台

[**All 162 stations in France →**](../README.md)

---

[← France](../README.md) · [Europe](../../README.md) · [All countries](../../../README.md) · [Repo home](../../../../README.md) · [globalradio.app](https://globalradio.app)
