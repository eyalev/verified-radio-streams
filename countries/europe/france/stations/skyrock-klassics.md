...
🇫🇷 Radio from **[France](../README.md)** · France continentale

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/france/skyrock-klassics/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://skyrock.fm/)
- 🎧 Direct stream: [`https://icecast.skyrock.net/s/klassiks_aac_64k?tvr_name=radiofr&tvr_section1=64aac`](https://icecast.skyrock.net/s/klassiks_aac_64k?tvr_name=radiofr&tvr_section1=64aac) — paste into VLC, mpv, or any player

```bash
mpv "https://icecast.skyrock.net/s/klassiks_aac_64k?tvr_name=radiofr&tvr_section1=64aac"
```
