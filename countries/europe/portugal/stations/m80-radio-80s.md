...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/portugal/m80-radio-80s/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://m80.iol.pt/)
- 🎧 Direct stream: [`https://stream-icy.bauermedia.pt/m8080.aac`](https://stream-icy.bauermedia.pt/m8080.aac) — paste into VLC, mpv, or any player

```bash
mpv "https://stream-icy.bauermedia.pt/m8080.aac"
```
