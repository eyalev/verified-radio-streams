...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/portugal/m80-radio-ballads/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://m80.iol.pt/)
- 🎧 Direct stream: [`https://stream-icy.bauermedia.pt/m80ballads.aac`](https://stream-icy.bauermedia.pt/m80ballads.aac) — paste into VLC, mpv, or any player

```bash
mpv "https://stream-icy.bauermedia.pt/m80ballads.aac"
```
