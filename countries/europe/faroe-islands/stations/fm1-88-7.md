...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/faroe-islands/fm1-88-7/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.fm1.fo/)
- 🎧 Direct stream: [`https://stream-secure.midlar.fo/fm1-128`](https://stream-secure.midlar.fo/fm1-128) — paste into VLC, mpv, or any player

```bash
mpv "https://stream-secure.midlar.fo/fm1-128"
```
