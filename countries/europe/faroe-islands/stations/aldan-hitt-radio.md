...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/faroe-islands/aldan-hitt-radio/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.aldan.fo/)
- 🎧 Direct stream: [`https://streaming.radio.co/s4d14b9fcc/listen`](https://streaming.radio.co/s4d14b9fcc/listen) — paste into VLC, mpv, or any player

```bash
mpv "https://streaming.radio.co/s4d14b9fcc/listen"
```
