...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/sweden/sveriges-radio-p3/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://sverigesradio.se/)
- 🎧 Direct stream: [`https://live1.sr.se/p3-aac-320`](https://live1.sr.se/p3-aac-320) — paste into VLC, mpv, or any player

```bash
mpv "https://live1.sr.se/p3-aac-320"
```
