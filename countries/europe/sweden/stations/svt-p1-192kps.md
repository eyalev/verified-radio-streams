...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/sweden/svt-p1-192kps/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://sverigesradio.se/p1#)
- 🎧 Direct stream: [`https://live1.sr.se/p1-mp3-96`](https://live1.sr.se/p1-mp3-96) — paste into VLC, mpv, or any player

```bash
mpv "https://live1.sr.se/p1-mp3-96"
```
