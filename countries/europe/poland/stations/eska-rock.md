...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/poland/eska-rock/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.eskarock.pl/)
- 🎧 Direct stream: [`https://ic2.smcdn.pl/5380-1.mp3#ESKA_ROCK`](https://ic2.smcdn.pl/5380-1.mp3#ESKA_ROCK) — paste into VLC, mpv, or any player

```bash
mpv "https://ic2.smcdn.pl/5380-1.mp3#ESKA_ROCK"
```
