...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/poland/radio-plus/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.radioplus.pl/)
- 🎧 Direct stream: [`https://pl02.cdn.eurozet.pl/plu-waw.mp3?redirected=02`](https://pl02.cdn.eurozet.pl/plu-waw.mp3?redirected=02) — paste into VLC, mpv, or any player

```bash
mpv "https://pl02.cdn.eurozet.pl/plu-waw.mp3?redirected=02"
```
