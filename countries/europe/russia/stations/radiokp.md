...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/russia/radiokp/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://radiokp.ru/)
- 🎧 Direct stream: [`https://kpradio.hostingradio.ru:8000/64`](https://kpradio.hostingradio.ru:8000/64) — paste into VLC, mpv, or any player

```bash
mpv "https://kpradio.hostingradio.ru:8000/64"
```
