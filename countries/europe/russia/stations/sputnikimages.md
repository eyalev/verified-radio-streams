...
- ▶︎ **[Play it on globalradio.app](https://globalradio.app/russia/sputnikimages/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://sputnikimages.com/)
- 🎧 Direct stream: [`https://icecast-rian.cdnvideo.ru/voicerus`](https://icecast-rian.cdnvideo.ru/voicerus) — paste into VLC, mpv, or any player

```bash
mpv "https://icecast-rian.cdnvideo.ru/voicerus"
```
