...
🇺🇲 Radio from **[U.S. Outlying Islands](../README.md)**

## Listen

- ▶︎ **[Play it on globalradio.app](https://globalradio.app/u-s-outlying-islands/radio-farda/)** — plays in the browser, nothing to install
- 🌐 [The station's own website](https://www.radiofarda.com/)
- 🎧 Direct stream: [`https://stream.radiojar.com/cp13r2cpn3quv`](https://stream.radiojar.com/cp13r2cpn3quv) — paste into VLC, mpv, or any player

```bash
mpv "https://stream.radiojar.com/cp13r2cpn3quv"
```
